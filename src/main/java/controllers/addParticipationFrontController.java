...
public class addParticipationFrontController implements Initializable {
    ...
    void ajouterParticipation(ActionEvent event) throws IOException {
        ...
        if (!validateInputs())
        {
            ...
            Participation p = new Participation( item.getId(),role, statut, feedback, name);
