...
public class DisplayRendezVousController {
    ...
    private void generatePDF(ActionEvent event) {
        try {
            PDFGenerator.generatePDF(rendezVousService.getAll());
            // Afficher un message de réussite ou effectuer d'autres actions si nécessaire
            showAlert(Alert.AlertType.INFORMATION, "Success", "PDF generated successfully", "The PDF file was generated successfully.");
        } catch (IOException e) {
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Error", "Error generating PDF", "An error occurred while generating the PDF file.");
        }
    }
