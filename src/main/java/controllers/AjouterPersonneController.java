...
public class AjouterPersonneController implements Initializable {
    ...
    void ajouterUSer() {
            ...
            try {
                uService.ajouter(new User(idUsername.getText(), idEmail.getText(), idCountry.getText(), Integer.parseInt(idCin.getText()), idRole.getValue(), idDateBirth.getValue(), idPassword.getText()));
