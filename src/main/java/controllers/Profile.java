...
public class Profile implements Initializable {
    ...
    void addPost(ActionEvent event) throws IOException, MessagingException {
        ...
        publication.setUser_id(userService.getUser().getId());
...
public static String filterContent(String content) throws IOException {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        List<Publication> publications = publicationService.getPublicationsByUserId(userService.getUser().getId());
        ...
        for (int i = publications.size() - 1; i >= 0; i--) {
            ...
            try {
                ...
                controller.getUsername().setText(userService.getUser().getUsername());
                ...
                if(likeService.getLikeByIdPublicationAndIdUser(publication.getId(),userService.getUser().getId())==null)
                {controller.getImgReaction().setImage(new Image("image/disliked.png"));}
                else {
                    controller.getImgReaction().setImage(new Image("image/liked.png"));
                }
...
//                    Image image = new Image(bis);
                ...
                controller2.getUsername().setText(userService.getUser().getUsername());
                ...
                for (Commentaire commentaire : commentaires) {
                    ...
                    try {
                        ...
                        controller1.getUsername().setText(u.getUserById(commentaire.getUser_id()).getUsername());
