...
public class EditEventController {
    ...
    public void initData(Event event) {
        ...
        try {
            ...
            txtImageEvent.setImage(new Image("file:/C:/Users/Rihab/Desktop/Workshop-JDBC-JavaFX-master/src/main/java/uploads/"+eventToUpdate1.getImage_e()));
    ...
    void updateImage(ActionEvent event) throws IOException {
        ...
        if (selectedImageFile != null) {
            ...
            Path destinationDir = Paths.get("C:", "Users", "Rihab", "Desktop", "Workshop-JDBC-JavaFX-master", "src", "main", "java", "uploads");
